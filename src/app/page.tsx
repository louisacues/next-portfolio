    ...
    <>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          I'm Louisass, a frontend developer with two years of hands-on experience building a Project Management & Audit platform for accounting firms and crafting high-performance company websites, gaining proficiency in various frontend technologies. I am passionate about coding and always eager to take on new challenges in this dynamic field.
          </p>
